...
<div class="h-full md:px-32 px-4 mx-auto">
  ...
  <div class="border-b-2 block">
    ...
    <form class="w-full p-4 sm:p-6 lg:p-8 bg-white lg:ml-4 shadow-md" method="POST" action="edit.php?id=<?php echo $postID ?>" enctype="multipart/form-data">
<div>
  ...
  <?php endif;?>
      ...
      <div class="rounded">
        <div class="pb-4">
        <label for="ID" class="font-semibold text-gray-700 block pb-1">Title</label>
          <input disabled value="<?php echo $postID ?>" id="id" name="postid" class="border-2 border-gray-400 transition-all ease-in-out duration-300 focus:bg-gray-200 focus:outline-none outline-none rounded-lg text-gray-700 px-4 py-2 w-full" type="text" />
          <label for="title" class="font-semibold text-gray-700 block pb-1">Title</label>
          <input value="<?php echo $postTitle ?>" id="title" name="title" class="border-2 border-gray-400 transition-all ease-in-out duration-300 focus:bg-gray-200 focus:outline-none outline-none rounded-lg text-gray-700 px-4 py-2 w-full" type="text" />
    ...
    <textarea id="description" name="description" class="h-40 resize-none border-2 border-gray-400 transition-all ease-in-out duration-300 focus:bg-gray-200 focus:outline-none outline-none rounded-lg text-gray-700 px-4 py-2 w-full" type="text"><?php echo $postDescription ?></textarea>
        </div>
      </div>
      <button type="submit" name="edit" class="rounded-md transition-all ease-in-out duration-300 w-full py-3 font-medium tracking-widest text-white uppercase bg-black shadow-lg outline-none focus:outline-none hover:bg-gray-700 hover:shadow-none">
        Edit
      </button>
    </form>
